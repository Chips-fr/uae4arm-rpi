...
static int cnt = 0,toto=0;
extern short signed int SNDBUF[1024*2];

void testsnd(int len)
{


cnt++;
	if(toto<1)memcpy(SNDBUF, sndbuffer[cnt%SOUND_BUFFERS_COUNT], MIN(SNDBUFFER_LEN*2, len));
//printf("cnt:%d l:%d pos:%d blen:%d\n",cnt,len,cnt%SOUND_BUFFERS_COUNT,SNDBUFFER_LEN*2);
